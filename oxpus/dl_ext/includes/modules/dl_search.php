...
else
{
	...
	*/
	...
	$select_categories .= \oxpus\dl_ext\includes\classes\ dl_extra::dl_dropdown(0, 0, 0, 'auth_view');
	...
	$this->template->assign_vars(array(
		'S_DL_SEARCH_ACTION'	=> $this->helper->route('dl_ext_controller', array('view' => 'search')),
