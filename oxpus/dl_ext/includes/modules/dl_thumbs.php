...
if ($submit && !$action)
{
	...
	$message = $thumb_message . '<br /><br />' . $this->language->lang('CLICK_RETURN_THUMBS', '<a href="' . $this->helper->route('dl_ext_controller', array('view' => 'thumbs', 'df_id' => $df_id, 'cat' => $cat_id)) . '">', '</a>');
...
$thumb_max_size = $this->language->lang('DL_THUMB_DIM_SIZE', $this->config['dl_thumb_xsize'], $this->config['dl_thumb_ysize'], \oxpus\dl_ext\includes\classes\ dl_format::dl_size($this->config['dl_thumb_fsize']));
