...
class main_module
{
	...
	function main($id, $mode)
	{
		...
		*/
		...
		$dl_mod = new \oxpus\dl_ext\includes\classes\ dl_mod($phpbb_root_path, $phpEx, $ext_path);
		$dl_mod->register();
		...
		*/
		switch($mode)
		{
			...
			case 'favorite':
				...
				*/
				$access_cat = array();
				$access_cat = \oxpus\dl_ext\includes\classes\ dl_main::full_index('', 0, 0, 0, 1);
				...
				*/
				...
				if ($total_favorites)
				{
					while ($row = $db->sql_fetchrow($result))
					{
						...
						$dl_nav = \oxpus\dl_ext\includes\classes\ dl_nav::nav('', $row['cat'], 'links', $tmp_nav).'&nbsp;&raquo;';
