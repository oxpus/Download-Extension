...
class broken extends \phpbb\notification\type\base
{
	...
	*/
	...
	{
		return [
			'REPORTER'				=> strip_tags(htmlspecialchars_decode($this->get_data('reporter'), ENT_COMPAT)),
			'REPORT_NOTIFY_TEXT'	=> strip_tags(htmlspecialchars_decode($this->get_data('report_notify_text'), ENT_COMPAT)),
