...
class comments extends \phpbb\notification\type\base
{
	...
	{
		return 'oxpus.dlext.notification.type.comments';
	}
	...
	{
		return $this->language->lang('DL_NOTIFY_COMMENTS', $this->get_data('description'));
	}
	...
	{
		return '@oxpus_dlext/downloads_comment_notify';
	}
	/**
	...
	{
		return $this->helper->route('oxpus_dlext_details', ['view' => 'comment', 'action' => 'view', 'df_id' => $this->get_data('df_id')]);
	}
