...
class bt_assign extends \phpbb\notification\type\base
{
	...
	{
		return 'oxpus.dlext.notification.type.bt_assign';
	}
	...
	{
		return $this->language->lang('DL_NOTIFY_BT_ASSIGN', $this->get_data('report_title'));
	}
	...
	{
		return '@oxpus_dlext/dl_bt_assign';
	}
	/**
