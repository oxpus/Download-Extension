...
class bt_status extends \phpbb\notification\type\base
{
	...
	{
		return [
			'REPORT_TITLE'	=> strip_tags(html_entity_decode($this->get_data('report_title'), ENT_COMPAT)),
			'STATUS'		=> strip_tags(html_entity_decode($this->language->lang('DL_REPORT_STATUS_' . $this->get_data('report_status'), ENT_COMPAT))),
			'STATUS_TEXT'	=> strip_tags(html_entity_decode($this->get_data('status_text'), ENT_COMPAT)),
