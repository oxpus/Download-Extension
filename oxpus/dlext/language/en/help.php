...
$lang = array_merge($lang, [
	...
	'HELP_DL_FILES_URL'			=> 'The file name of this download.<br />Enter this name without a leading file path or slash.<br />The file must exist before saving this download otherwise you will get an error message.<br />Please note that using forbidden file extensions blocks saving the file!',
	...
	'HELP_DL_STATISTICS'			=> 'Enables detailed statistics about the downlodPlease nfiles.<br />Note that these statistics will produce additional database queries and datasets in a separate table.',
