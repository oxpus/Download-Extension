...
$lang = array_merge($lang, array(
	...
	'DL_BASE_SWITCH'				=> 'Deaktiviere automatisches Verschieben der Dateiablage',
	...
	'DL_FILEBASE_MANUALLY'			=> 'Die Dateiablage wurde umgestellt. Bitte verschiebe die Dateien selber an den Zielort, bevor du weiter mit dem Forum arbeitest.',
	...
	'DL_MODCP_CAPPROVE'				=> 'Moderator Panel - Kommentare freigeben',
	...
	'DOWNLOAD_PATH_EXPLAIN'	=> 'Hiermit kann man die Dateiablage innerhalb oder ausserhalb der Erweiterung einrichten.<br />Im Standard werden alle Dateien innerhalb der Erweiterung abgelegt. Wenn du diese Option umschaltest, bedenke bitte dass es je nach Anzahl der bereits vorhandenen Downloads eine Weile dauern kann, bis die Ablage verschoben wurde.<br />Möchtest du die Dateiablage selber im Zielordner einrichten (z. B. mit einem FTP-Client), dann wähle "Ja" bei der nachfolgenen Option, um eine automatische Änderung des Pfades zu unterbinden.<br /><strong>Achtung:</strong><br />Während einer automatischen Umstellung der Dateiablage wird das Board gesperrt, um während der Verschiebung der Dateien neue oder geänderte Daten auszuklammern und damit Fehler zu vermeiden!',
