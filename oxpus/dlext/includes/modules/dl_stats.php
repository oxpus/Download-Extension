			...
			*/
			...
			if ($total_top_ten)
			{
				...
				while ($row = $this->db->sql_fetchrow($result))
				{
					...
					$description	= $row['description'];
					$cat_name		= $row['cat_name'];
					$dl_traffic		= \oxpus\dlext\includes\classes\ dl_format::dl_size($row['month_traffic']);
			...
			*/
			...
			if ($total_top_ten)
			{
				...
				while ($row = $this->db->sql_fetchrow($result))
				{
					...
					$description	= $row['description'];
					$cat_name		= $row['cat_name'];
					$dl_traffic		= \oxpus\dlext\includes\classes\ dl_format::dl_size($row['overall_traffic']);
			...
			*/
			...
			if ($total_top_ten)
			{
				...
				while ($row = $this->db->sql_fetchrow($result))
				{
					...
					$dl_traffic	= \oxpus\dlext\includes\classes\ dl_format::dl_size($row['dl_traffic']);
