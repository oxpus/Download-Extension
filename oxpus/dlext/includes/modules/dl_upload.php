...
$s_cat_select .= \oxpus\dlext\includes\classes\ dl_extra::dl_dropdown(0, 0, $cat_id, 'auth_up');
$s_cat_select .= '</select>';
...
$file_size_ary		= \oxpus\dlext\includes\classes\ dl_format::dl_size(0, 2, 'select');
