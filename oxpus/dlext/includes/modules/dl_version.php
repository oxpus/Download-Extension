...
*/
$dl_file = array();
$dl_file = \oxpus\dlext\includes\classes\ dl_files::all_files(0, '', 'ASC', '', $df_id, 0, '*');
...
$auth_view = \oxpus\dlext\includes\classes\ dl_auth::user_auth($cat_id, 'auth_view');
$auth_dl = \oxpus\dlext\includes\classes\ dl_auth::user_auth($cat_id, 'auth_dl');
...
{
	$file_size_out = \oxpus\dlext\includes\classes\ dl_format::dl_size($ver_data['ver_file_size'], 2);
}
else
{
