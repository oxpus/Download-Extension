...
*/
$dl_files = array();
$dl_files = \oxpus\dlext\includes\classes\ dl_files::all_files(0, '', 'ASC', '', $df_id, 0, '*');
...
$thumb_max_size = $this->language->lang('DL_THUMB_DIM_SIZE', $this->config['dl_thumb_xsize'], $this->config['dl_thumb_ysize'], \oxpus\dlext\includes\classes\ dl_format::dl_size($this->config['dl_thumb_fsize']));
