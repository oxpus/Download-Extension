...
$hacklist = array();
$hacklist = \oxpus\dlext\includes\classes\ dl_hacklist::hacks_index();
...
$dl_files = array();
$dl_files = \oxpus\dlext\includes\classes\ dl_hacklist::all_files($sql_sort_by, $sql_order, $start, $this->config['dl_links_per_page']);

$all_files = array();
$all_files = \oxpus\dlext\includes\classes\ dl_hacklist::all_files('id', 'ASC');
